...
//	private boolean pollingServiceBound;
//	private PollingService pollingService;
//	private ServiceConnection pollingServiceConn = new ServiceConnection() {
//		public void onServiceConnected(ComponentName className, IBinder service) {
//			pollingService = ((PollingService.LocalBinder) service).getService();
//			Log.d("onServiceConnected", "got polling service");
//		}
//		public void onServiceDisconnected(ComponentName className) {
//			pollingService = null;
//			Log.d("onServiceDisconnected", "no more polling service");
//		}
//	};
//	PollingServiceReceiver pollingReceiver;
//	
//	private class PollingServiceReceiver extends BroadcastReceiver {
//		@Override
//		public void onReceive(Context arg0, Intent intent) {
//			int weather_id = intent.getIntExtra("WEATHER_ID", 0);
//			int temp_c = intent.getIntExtra("WEATHER_TEMP", 0);
//			Log.d("PollingServiceReceiver", String.format("weather_id=%d temp_c=%d", weather_id, temp_c));
//		}
//	}
	
	// --------------------------------------- SERVICE -------------------------------------------
//	private class PollingService extends Service {
//		private ScheduledThreadPoolExecutor threadPoolExec;
//		private UpdateWatchAction updateWatch;
//		
...
//        locationMgr = (LocationManager) this.getSystemService(Context.LOCATION_SERVICE);
     ...
     //   android.os.Debug.waitForDebugger();
        ...
        // Register to get updates from the service.
//        pollingReceiver = new PollingServiceReceiver();
//        IntentFilter intent_filter = new IntentFilter();
//        intent_filter.addAction(PollingService.GET_WEATHER);
//        intent_filter.addAction(PollingService.GET_BATTERY);
//        registerReceiver(pollingReceiver, intent_filter);
        
        // Start the service.
//        Intent intent = new Intent(MainActivity.this, org.beegle.gotthetimecompanion.PollingService.class);
//        //intent.putExtra(name, value); // THis is data from the activity to the service, like watch app UUID maybe?
//        startService(intent);
    ...
    @Override
    public void onDestroy() {
//    	unregisterService(pollingReceiver);
    	super.onDestroy();
//    	doUnbindService();
    }
...
//	    Intent intent = bindService(new Intent(Binding.this, PollingService.class), pollingServiceConn, Context.BIND_AUTO_CREATE);
//	    
...
//	        unbindService(pollingServiceConn);
...
//	}
	...
	public void updateBattery(View view) {
		Log.d("MainActivity", "updateBattery");
		doBatteryUpdate();
	}
